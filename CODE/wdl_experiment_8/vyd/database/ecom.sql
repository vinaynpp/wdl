...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2020 at 04:30 PM
...
INSERT INTO `admin_users` (`id`, `username`, `password`, `detail`) VALUES
(1, 'admin', 'admin', 'admin'),
(2, 'admin', 'admin', 'admin');
...
(14, 'THINK AND GROW RICH', 176, 4, 'think_and_grow_rich.jpg', 'Think and Grow Rich was written by Napoleon Hill in 1937 and promoted as a personal development and self-improvement book. He claimed to be inspired by a suggestion from business magnate and later-philanthropist Andrew Carnegie.', 0);
...
(1, 'user', 'user', 'user'),
(2, 'new1', 'new1', 'darshanpanchal@singhaniaschools.org'),
(4, 'vinay', 'khuljasimsim', 'yaadnahiabhi@gmail.com'),
(5, 'vinaysomaiya', 'newpassword', 'vinay.np@somaiya.edu');
